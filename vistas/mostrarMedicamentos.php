     ...
     while($filasClinicas = mysqli_fetch_array($cantidadClinicas))
        {
            ...
            $currentDate = strtotime(date("Y-m-d")); // Fecha actual

            if ($dt < $currentDate) {
                // Químico caducado
                $m_color = 'text-danger';
            } elseif ($dt < strtotime("+3 months", $currentDate)) {
                // Químico próximo a caducar dentro de 6 meses
                $m_color = 'text-warning';
            } else {
                // Químico en buen estado
                $m_color = 'text-success';
            }
                ?>
                    <tr>                        
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="../crr/insertarMedicamento.php" method="post" class="row w-100">
