              ...
              while($filasClinicas = mysqli_fetch_array($cantidadClinicas))
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="../crr/eliminarCiudad.php?idCiudad=<?php echo $filasClinicas['idCiudad'] ?>" class="btn btn-danger">Eliminar</a></td>
                        <?php
                      }
                      else {
                        ?>
        ...
        <section class="modal">
            <div class="modal__container">
              <!-- nombre donacion ciudad direccion -->
                ...
                <form class="" action="../crr/insertarCiudad.php" method="post">
                  <div class="row mb-5">
                    <div class="col">
