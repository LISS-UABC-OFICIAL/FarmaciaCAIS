              ...
              while($filasClinicas = mysqli_fetch_array($cantidadClinicas))
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $filasClinicas['presentacion']?></td> <!-- presentacion -->
                        <td><?php echo $filasClinicas['unidades']?></td> <!-- unidades -->
                        <td><?php if ($filasClinicas['via_administracion']==1){ echo 'Oral'; }  else if ($filasClinicas['via_administracion']==2){ echo 'Inyectada'; } else if ($filasClinicas['via_administracion']==3){ echo 'Intravenosa'; }   ?></td> <!-- via de admin -->
                        <td ><?php
                          if (isset($dt)) {
                            echo date("d/m/Y", $dt);
                          }
