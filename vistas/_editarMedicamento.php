...
?>
                      ...
                      <form action="../crr/actualizarMedicamento.php" method="post" class="row w-100 mt-3">
                        ...
                        <div class="col-12">
                          ...
                          <a href="#" data-bs-toggle="modal" data-bs-target="#confirmacionEliminar" class="btn btn-danger">Eliminar</a>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmacionEliminarLabel">Confirmación de Eliminación</h5>
            ...
            <div class="modal-footer">
                ...
                <a href="../crr/eliminarMedicamento.php?idMedicamento=<?=$filaMedicamento['idMedicamento']?>&idUsuario=<?=$user_id?>" class="btn btn-danger">Eliminar</a>
            </div>
        </div>
    </div>
</div>
