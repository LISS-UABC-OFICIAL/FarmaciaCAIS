...
?>
<form action="../crr/actualizarUsuario.php" method="post" class="row mt-3">
	...
	<div class="col-12">
		...
		<?php if ($filaClinica['idUsuario'] != 1) { ?>
			<a href="../crr/eliminarUsuario.php?idUsuario=<?=$filaClinica['idUsuario']?>" class="btn btn-danger">Eliminar</a>
		<?php } ?>
	</div>
</form>