              ...
              while($filasClinicas = mysqli_fetch_array($cantidadClinicas))
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="../crr/eliminarPresentacion.php?idPresentacion=<?php echo $filasClinicas['idPresentacion'] ?>" class="btn btn-danger">Eliminar</a></td>
                        <?php
                      }
                      else {
                        ?>
        ...
        <section class="modal">
            <div class="modal__container">
              <!-- nombre donacion ciudad direccion -->
                ...
                <form class="" action="../crr/insertarPresentacion.php" method="post">
                  <div class="row mb-4">
                    <div class="col">
