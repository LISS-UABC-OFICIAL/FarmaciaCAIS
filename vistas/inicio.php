...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <?php include('../crr/menu.php'); ?>

        <!-- Content Start -->
        <div class="content">

            <?php include('../crr/navbar.php'); ?>
    ...
    <script src="../lib/exportexcel.js"></script>
    
    <!-- Template Javascript -->
    <script src="../lib/base/js/main.js"></script>
    <script>
        $(".export").click(function(){  
             $("#tablaClinicas").tableHTMLExport({
              type:'csv',
              filename:'Tabla-Medicamentos.csv',
              ignoreColumns: "#id-of-column",
            });
        });
        <?php if($_GET['insert'] == "successfully"){?>
			Swal.fire("Agregado", "El medicamento se ha agregado con exito", "success");
		<?php } ?>
		<?php if($_GET['update'] == "successfully"){?>
			Swal.fire("Actualizado", "El medicamento se ha actualizado con exito", "success");
		<?php } ?>
		<?php if($_GET['delete'] == "successfully"){?>
			Swal.fire("Eliminado", "El medicamento se ha eliminado", "error");
		<?php } ?>
    </script>
</body>
